...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const navItems = [
    { label: 'Bookings', href: '/admin/dashboard', icon: '📋' },
    { label: 'Slots', href: '/admin/slots', icon: '🗓️' },
  ];
      ...
      <div className="fixed inset-y-0 left-0 w-64 bg-slate-900 flex flex-col">
        <div className="p-6 border-b border-slate-700">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-teal-500 rounded-full flex items-center justify-center text-white font-bold text-sm">DS</div>
            <div>
